    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactDataModelID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StudentDataModelID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactDataModel", x => x.ContactDataModelID);
                    table.ForeignKey(
                        name: "FK_ContactDataModel_StudentDataModel_StudentDataModelID",
                        column: x => x.StudentDataModelID,
